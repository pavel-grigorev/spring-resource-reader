...
public class PropertiesResourceMapper extends BaseReturnTypeResourceMapper<Properties> {
  public static final String NAME = "org.thepavel.resource.mapper.internalPropertiesResourceMapper";
  ...
  @Override
  public Properties map(Resource resource, MethodMetadata methodMetadata) throws IOException {
