...
public class StringResourceMapper extends BaseReturnTypeResourceMapper<String> {
  public static final String NAME = "org.thepavel.resource.mapper.internalStringResourceMapper";
  ...
  @Override
  public String map(Resource resource, MethodMetadata methodMetadata) throws IOException {
